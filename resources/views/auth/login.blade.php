...
<body>
    <div class="container col-md-4 offset-md-4" style="margin-top: 120px; border-radius: 10px">
        @if (session('message'))
...
#card-bodyy {
    background-image: linear-gradient(to right, rgb(17, 162, 172), rgb(19, 131, 65));
}
#eye:active {
    color: blue;
}
