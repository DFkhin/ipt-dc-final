<div>
    <div class="container mt-2">
        ...
        @endif
        <div class='btn btn-success btn-lg float-end mb-2' data-toggle="modal" data-target="#modal-roles">Add Roles</div>
        ...
        <div class="card-body">
            <table class="table table-striped shadow table-bordered table-md table-hover" >
                <thead class="bg-primary text-white">
                    <tr class="col mb-3 " style="background-color: rgb(17, 162, 172); height:50px">
                        <th>Name</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td>{{ $role->name }}</td>
                        <td>
                            <a href="" class="btn btn-primary" id="ic" title="Edit" data-toggle="modal" data-target="#update-modal-roles" wire:click="editRoles({{ $role->id }})">EDIT</a>
