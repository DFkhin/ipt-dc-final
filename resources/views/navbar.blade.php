<nav class="navbar navbar-expand-lg ">
    <img src="{{ asset('images/logo.jpg') }}" alt="logo" class="img-fluid img-responsive" title="brand logo" style="border-radius:30px; height:50px; width: 50px; margin-left: 20px; cursor: pointer">
    <a href="#" style="text-decoration: none;"> <h2 class="p-2" style="font-family: ubuntu; color: rgb(255, 255, 255); stroke:black">Green Wheels</h2></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav d-flex align-items-center justify-content-center">
            @role('admin')
            <li class="nav-item">
                <a style="margin-left: 0px" class="nav-link text-white {{ 'admin' == request()->path() ? 'active' : '' }}" href="{{ '/admin' }}">Dashboard</a>
            </li>
            @endrole
            <li class="nav-item" >
                <a class="nav-link text-white {{ 'recent-post' == request()->path() ? 'active' : '' }}" href="{{ '/recent-blog' }}">Recent Blogs</a>
            </li>
            <li class="nav-item" >
                <a class="nav-link text-white {{ 'create-post' == request()->path() ? 'active' : '' }}" href="{{ '/create-blog' }}">Create Blog</a>
            </li>
            @role('admin')
            ...
            <span class="nav-line"></span>
            <li>
                <a class="nav-link text-white {{'my-post' == request()->path() ? 'active' : ''}} "href="{{'/my-blog'}}"}> My Blogs</a>
            </li>
            <span class="nav-line"></span>
                    <span class="nav-line"></span>
                    <li class="nav-item" style="margin-left: 12rem">
                        <a  class="nav-link text-white {{ 'admin/roles' == request()->path() ? 'active' : '' }}" href="{{ route('admin.roles.index') }}">Roles</a>
                    </li>
                    <span class="nav-line"></span>
                    <li class="nav-item">
                        <a class="nav-link text-white {{ 'admin/permissions' == request()->path() ? 'active' : '' }}" href="{{ route('admin.permissions.index') }}">Permissions</a>
                    </li>
                    <li class="nav-item">
                        <a  class="nav-link text-white {{ 'admin/users' == request()->path() ? 'active' : '' }}" href="{{ route('admin.users.index') }}">Users</a>
                    </li>
                    <span class="nav-line"></span>
            </div>
            @endrole
        ...
        <ul class="navbar-nav ms-auto">
            <div class="dropdown dropstart">
                <img src="
                {{(Auth::user()->gender === 'Male') ? asset('images/f1.jpg') : ''}}
                ...
                <ul class="dropdown-menu" id="select2">
                    ...
                    {{(Auth::user()->gender === 'Bisexual') ? asset('images/bisexual.png') : ''}}
                    ">
                    <span id="profile-name"><a href="{{ '/my-blog' }}">{{Auth::user()->name}}</a></span>
